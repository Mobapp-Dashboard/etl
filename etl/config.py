...
PSQL_TYPES_META_TRAJ = {
    postgresql.INTEGER, postgresql.VARCHAR, postgresql.TIMESTAMP,
    postgresql.INTEGER, postgresql.VARCHAR, postgresql.INTEGER
}
...
PSQL_TYPE_PT = [
    ...
    postgresql.NUMERIC, postgresql.NUMERIC, postgresql.INTEGER, postgresql.INTEGER,
    postgresql.NUMERIC, postgresql.INTEGER, postgresql.INTEGER, postgresql.INTEGER,
    postgresql.INTEGER, postgresql.INTEGER, postgresql.NUMERIC, postgresql.NUMERIC,
    postgresql.NUMERIC, postgresql.NUMERIC, postgresql.TIMESTAMP, postgresql.TIMESTAMP
]
